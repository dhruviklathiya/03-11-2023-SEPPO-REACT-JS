    ...
    <main>
                            ...
                            <div class="swiper-wrapper">
                              <div class="swiper-slide">
                                <div class="client_slider_main">
                                    <img class="sec_client_quote" src="../IMAGES/quotes_image.png" alt="quotationimage"/>
        ...
        <section class="sec_portfolio commonsec" id="asec_portfolio">
            <div class="crossbox d-flex align-items-center portfolio_cross">
                ...
                <div class="row">
                    <div class="col-3 m-0 p-0"><div class="portfolio_img_out"><img src="../IMAGES/portfolio_item_01.jpg" alt="port1"/></div></div>
                    <div class="col-6 m-0 p-0"><div class="portfolio_img_out"><img src="../IMAGES/portfolio_item_02.jpg" alt="port2"/></div></div>
                    <div class="col-3 m-0 p-0"><div class="portfolio_img_out"><img src="../IMAGES/portfolio_item_03.jpg" alt="port3"/></div><div class="portfolio_img_out"><img src="../IMAGES/portfolio_item_04.jpg" alt="port4"/></div></div>
                </div>
        </section> 
        ...
        <section class="sec_team" id="asec_team">
            ...
            <div class="container">
                <div class="team1"><img src="../IMAGES/about_item_01.jpg" alt="team1"/></div>
                ...
                <div class="team4"><img src="../IMAGES/about_item_02.jpg" alt="team2"/></div>
                ...
                <div class="team7"><img src="../IMAGES/about_item_03.jpg" alt="team3"/></div>
